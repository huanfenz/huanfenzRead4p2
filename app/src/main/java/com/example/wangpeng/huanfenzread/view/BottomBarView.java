...
public class BottomBarView extends View {
    ...
    public BottomBarView setContainer(int containerId) {
        this.containerId = containerId;
        return this;
    }

    public BottomBarView setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {//支持"#333333"这种形式
        titleColorBefore = Color.parseColor(beforeResCode);
        titleColorAfter = Color.parseColor(AfterResCode);
        return this;
    }

    public BottomBarView setTitleSize(int titleSizeInDp) {
        this.titleSizeInDp = titleSizeInDp;
        return this;
    }

    public BottomBarView setIconWidth(int iconWidth) {
        this.iconWidth = iconWidth;
        return this;
    }

    public BottomBarView setTitleIconMargin(int titleIconMargin) {
        this.titleIconMargin = titleIconMargin;
        return this;
    }

    public BottomBarView setIconHeight(int iconHeight) {
        this.iconHeight = iconHeight;
        return this;
    }

    public BottomBarView addItem(Class fragmentClass, String title, int iconResBefore, int iconResAfter) {
    ...
    public BottomBarView setFirstChecked(int firstCheckedIndex) {//从0开始
